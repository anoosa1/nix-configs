{ inputs, self, ... }: {
  ...
  flake.nixosModules.astra = { lib, ... }: {
    ...
    networking = {
      ...
      hosts = {
        "127.0.0.1" = [ "search.asherif.xyz" "hub.asherif.xyz" "home.asherif.xyz" "git.asherif.xyz" "x.asherif.xyz" "auth.asherif.xyz" "qbit.asherif.xyz" "tty.asherif.xyz" "memory.asherif.xyz" ];
      };
